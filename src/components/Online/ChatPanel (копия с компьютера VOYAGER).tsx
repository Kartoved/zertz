...
export function ChatPanel() {
  ...
  return (
    <div
      className="flex flex-col h-full min-h-0 overflow-hidden bg-white dark:bg-gray-800 rounded-lg shadow-md"
          ...
          messages.map((msg) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className="break-words whitespace-pre-wrap">{msg.message}</span>
                </div>
              </div>
            );
          })
