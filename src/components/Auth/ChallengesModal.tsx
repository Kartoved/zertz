      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-lg w-full max-h-[70vh] overflow-hidden flex flex-col">
        ...
        <div className="p-4 border-b dark:border-gray-700">
          <div className="flex justify-between items-center mb-3">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">Вызовы</h2>
        ...
        <div className="flex-1 overflow-auto">
          {isLoading ? (
            ...
            <div className="p-8 text-center text-gray-500 dark:text-gray-400">
              {tab === 'incoming' ? 'Нет входящих вызовов' : 'Нет исходящих вызовов'}
            </div>
          ) : (
                ...
                <div key={c.id} className="p-3 flex items-center justify-between gap-3">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400 flex gap-2">
                      <span>Поле: {BOARD_LABELS[c.boardSize]}</span>
                      {c.rated && <span className="text-purple-500 font-medium">Рейтинговая</span>}
