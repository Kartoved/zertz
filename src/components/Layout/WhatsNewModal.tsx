  ...
  },
  {
    ...
    changes: {
      ru: [
        ...
        'Студии: стрелки и маркеры на доске (правая кнопка мыши, как на Lichess) — 4 цвета через Shift/Alt/Ctrl, сохраняются к каждой позиции урока',
      ...
      en: [
        ...
        'Studies: board arrows and markers (right mouse button, Lichess-style) — 4 colors via Shift/Alt/Ctrl, saved per lesson position',
      ...
      eo: [
        ...
        'Studioj: sagoj kaj markiloj sur la tabulo (dekstra musbutono, Lichess-stile) — 4 koloroj per Shift/Alt/Ctrl, konservataj por ĉiu leciona pozicio',
