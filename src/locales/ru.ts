export const ru = {
  ...
  variantNeedsOpponentFirst: 'Первый ход варианта должен быть за соперника',
  ...
  armFromOwnMoveHint: 'Сыграть мой ход сейчас и зарядить ответы',
  confirmPlayOwnMove: 'Первый ход варианта — ваш ({move}). Сыграть его сейчас на доске? Остальное сохранится как предходы.',
  confirmOverwriteReply: 'На эту позицию уже запланирован ваш ход {existing}. Заменить его этим вариантом? Ветки под старым ходом будут удалены.',
  ...
  armOwnTurnHint: 'Сейчас ваш ход. Сначала сыграйте свой ход на доске, затем стройте ответы на ходы соперника и заряжайте.',
