export const eo = {
  ...
  variantNeedsOpponentFirst: 'La unua movo de varianto devas esti de kontraŭulo',
  ...
  armFromOwnMoveHint: 'Ludi mian movon nun kaj ŝargi la respondojn',
  ...
  confirmOverwriteReply: 'Respondo {existing} jam estas planita por ĉi tiu pozicio. Ĉu anstataŭigi ĝin per ĉi tiu linio? Branĉoj sub la malnova respondo forigiĝos.',
  ...
  armOwnTurnHint: 'Estas via vico. Unue ludu vian movon sur la tabulo, poste konstruu respondojn al la movoj de la kontraŭulo kaj ŝargu.',
