export const eo = {
  ...
  importPosition: 'Importi pozicion',
  importPositionHint: 'Algluu ZIP-pozicion aŭ ZEN-ludon',
  importLoad: 'Ŝargi',
  importError: 'Ne eblis analizi la notacion',
  ...
  studyTraining: 'Trejnado',
  studyTrainingHidden: 'Solvo kaŝita',
  metaTraining: 'Malfermi en trejnreĝimo (solvo kaŝita)',
  ...
  arenaCreate: 'Krei arenon',
  arenaName: 'Nomo',
  arenaStartsInMin: 'Komenciĝas post (min)',
  arenaDurationMin: 'Daŭro (min)',
  arenaBerserk: 'Berserk',
  arenaSectionActive: 'Nun aktivaj',
  arenaSectionUpcoming: 'Venontaj',
  arenaSectionFinished: 'Finitaj',
  arenaStatusScheduled: 'Planita',
  arenaStatusActive: 'Aktiva',
  arenaStatusFinished: 'Finita',
  arenaJoin: 'Aliĝi',
  arenaPause: 'Paŭzi',
  arenaResume: 'Daŭrigi',
  arenaStartsIn: 'Komenco post',
  arenaTimeLeft: 'Restas',
  arenaScore: 'Poentoj',
  arenaStreak: 'Serio',
  arenaGamesCol: 'Ludoj',
  arenaPlayers: 'Ludantoj',
  arenaEmpty: 'Ankoraŭ neniuj turniroj',
  arenaNoPlayers: 'Ankoraŭ neniuj ludantoj',
  arenaWinner: 'Venkinto',
  arenaGameReady: 'Via ludo pretas',
  arenaGoToGame: 'Al la ludo',
  arenaBackToArena: 'Al la turniro',
  arenaBerserkBtn: 'Berserk!',
  arenaBerserkHint: 'Duonigi horloĝon por +1 poento ĉe venko',
  arenaRatedBlitz: 'Taksata · fulmo 5+5',
  arenaStartAt: 'Komenco (dato kaj horo)',
  arenaRepeat: 'Ripeto',
  arenaRepeatOnce: 'Unufoja',
  arenaRepeatDaily: 'Ĉiutage',
  arenaRepeatWeekly: 'Ĉiusemajne',
  arenaRecurring: 'Ripetiĝanta',
  arenaEdit: 'Redakti',
  arenaDelete: 'Forigi',
  arenaSave: 'Konservi',
  arenaSeries: 'Serio',
  arenaEditSeries: 'Redakti serion',
  arenaSkipOccurrence: 'Preterlasi ĉi tiun',
  arenaStopSeries: 'Ĉesigi serion',
  arenaDeleteConfirm: 'Ĉu forigi la turniron?',
