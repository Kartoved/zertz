export const en = {
  ...
  arenaName: 'Name',
  arenaStartsInMin: 'Starts in (min)',
  arenaDurationMin: 'Duration (min)',
  arenaBerserk: 'Berserk',
  arenaSectionActive: 'Live now',
  arenaSectionUpcoming: 'Upcoming',
  arenaSectionFinished: 'Finished',
  arenaStatusScheduled: 'Scheduled',
  arenaStatusActive: 'Live',
  arenaStatusFinished: 'Finished',
  arenaJoin: 'Join',
  arenaPause: 'Pause',
  arenaResume: 'Resume',
  arenaStartsIn: 'Starts in',
  arenaTimeLeft: 'Time left',
  arenaScore: 'Score',
  arenaStreak: 'Streak',
  arenaGamesCol: 'Games',
  arenaPlayers: 'Players',
  arenaEmpty: 'No tournaments yet',
  arenaNoPlayers: 'No players yet',
  arenaWinner: 'Winner',
  arenaGameReady: 'Your game is ready',
  arenaGoToGame: 'Go to game',
  arenaBackToArena: 'Back to arena',
  arenaBerserkBtn: 'Berserk!',
  arenaBerserkHint: 'Halve your clock for +1 point on a win',
  arenaRatedBlitz: 'Rated · blitz 5+5',
  arenaStartAt: 'Start (date & time)',
  arenaRepeat: 'Repeat',
  arenaRepeatOnce: 'One-off',
  arenaRepeatDaily: 'Daily',
  arenaRepeatWeekly: 'Weekly',
  arenaRecurring: 'Recurring',
  arenaEdit: 'Edit',
  arenaDelete: 'Delete',
  arenaSave: 'Save',
  arenaSeries: 'Series',
  arenaEditSeries: 'Edit series',
  arenaSkipOccurrence: 'Skip this one',
  arenaStopSeries: 'Stop series',
  arenaDeleteConfirm: 'Delete this tournament?',
