export const en = {
  ...
  variantNeedsOpponentFirst: 'The first move of the variant must be the opponent\'s',
  ...
  armFromOwnMoveHint: 'Play my move now and arm the replies',
  confirmPlayOwnMove: 'The first move of this line is yours ({move}). Play it on the board now? The rest is saved as pre-moves.',
  confirmOverwriteReply: 'A reply {existing} is already planned for this position. Replace it with this line? Branches under the old reply will be removed.',
  ...
  armOwnTurnHint: 'It\'s your turn. Play your move on the board first, then build replies to the opponent\'s moves and arm them.',
